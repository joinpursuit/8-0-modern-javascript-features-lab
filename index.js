...
/*
  ...
  - Change the function to use arrow syntax, while keeping the name of the function the same. (V)
...
/*
  To update this function, you should:
  - Change the function to use arrow syntax, while keeping the name of the function the same. (V)
  - Set the default value of `distanceFromPlanetInKm` to "Unknown" as part of the function signature (parametros). (V)
  - Use object shorthand to create the new object.

  You should not need to make any other changes to the code.
*/
const createMoon = (name, planet, distanceFromPlanetInKm = "Unknown" ) => { //function default value aplications 
  if (!name || !planet) {
