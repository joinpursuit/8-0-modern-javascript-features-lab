...
getClosestToPlanet = (moons) => {
 // using deconstruction, the first variable will only take the first moon. Therefore, the rest of the moons don't need to be sliced since they are already covered by "...rest"
